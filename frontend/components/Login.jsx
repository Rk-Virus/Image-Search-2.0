...
import { loginUsingGoogle } from '../utils/apis';
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex items-center justify-center px-4">
      <div className="bg-white p-6 rounded-lg shadow-md w-full max-w-md">
        ...
        {error && (
          <div className="text-red-700 mb-4 text-sm">{error}</div>
        )}
        ...
        <form action="/api/auth/login" method="POST" noValidate>
          ...
          <div className="mb-4 flex items-center justify-between">
            <label className="flex items-center text-sm" style={{ fontWeight: 400 }}>
              <input type="checkbox" name="remember" value="1" className="mr-2" />
              Remember me
            </label>
            <a href="/forgot" className="text-blue-600 text-sm">Forgot?</a>
          </div>
